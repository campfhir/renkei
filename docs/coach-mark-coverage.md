...
| Jira space templates    | the org's templates, read-only; from the card    | —                         | None    |
...
| Entra Developer         | own Entra app, directory-wide scopes; developers | `connect-entra-developer` | Covered |
