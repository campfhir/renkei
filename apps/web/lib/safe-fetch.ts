 ...
 * document — OIDC issuer/discovery/token endpoints above all. Without it, a
 * caller who can set (or, on an unconfigured tenant, bootstrap) an OIDC
 * discovery URL could make the server issue requests to `169.254.169.254`
...
/** Whether an IP literal is in a private/reserved range we refuse to reach. */
