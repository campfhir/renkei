 ...
 *
 * Only `knowledge`: it is our own search surface rather than a product, and
 * the magnifier glyph says that better than any file would.
 *
 ...
 */
export const GLYPH_ONLY = new Set(['knowledge']);
