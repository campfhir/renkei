...
const HIDDEN = new Set([
  ...
  'source_at',
  'kind',
  // Rendered as a link of its own rather than as a row of raw href text.
  'url',
  // The machine-readable twins of fields shown by name. Kept in the record
  // — they are what an id search matches on — but a person reading a card
  // wants "Evan Jeing", not an accountId underneath it.
  'reporterId',
  'assigneeId',
  'authorId',
  'fromAddress',
