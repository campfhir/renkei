...
/**
 * One ADManager Plus instance's management page: connection details,
 * nothing else. There is deliberately no access management here — every
 * person connects the instance with their own ADManager Plus authtoken
 * on the connectors page, and ADManager Plus's own token scope and the
 * technician's delegated rights decide what that account may do.
 */
export default async function AdminAdManagerInstancePage({
  params,
}: {
    ...
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <section>
        ...
        <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          here: everyone connects it with their own ADManager Plus authtoken from the Connectors
          page, and the server judges each account.
        </p>
