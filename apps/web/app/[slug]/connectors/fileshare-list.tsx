...
/**
 * The live, stateful part of the file-shares card — where a person connects
 * an org share with their OWN credentials, the same gesture as every OAuth
 * card. The admin registers where a share lives; this list is who you are
 ...
 *
 * Split out of fileshares-connector.tsx so that file's header/description
 * can be a server component; every row here manages its own live state
 * (open connect-form, in-flight save, optimistic exposure toggle), so
