...
const RUN_EVENTS = [
  ...
  key: keyof NotificationPrefs & OverridableEvent,
  label: string,
  hint: string | null,
][];
      ...
      */}
      <section aria-labelledby="notifications-heading" className="space-y-3">
        ...
        <section className="rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-950">
          <div className="p-4 pb-3">
            ...
            <p className="mt-0.5 text-sm text-gray-600 dark:text-gray-400">
              ...
              it. Outlook and WebEx are unlikely choices here, but they&rsquo;re yours to make.
            </p>
          </div>
        ...
        <section className="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-950">
          ...
          <p className="mt-0.5 text-sm text-gray-600 dark:text-gray-400">
            Everything above is your general preference. Pick one of your own agents to set its own
            delivery for any of these events — an event you don&rsquo;t override here just falls
            through to the general preference.
          </p>
