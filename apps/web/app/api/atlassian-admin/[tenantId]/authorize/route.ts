...
/**
 * Authorize against the fifth Atlassian app ("Renkei Jira Admin") — Jira
 * administration on its own grant, with classic scopes. Same shape as the
 * Confluence authorize route: the user may narrow the org ceiling, never
 * widen it, and the pending row records provider + scopes for the shared
 * callback.
 */
