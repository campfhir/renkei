/**
 * Org-admin configuration of the FOURTH Atlassian OAuth app ("Renkei
 * Bitbucket": a Bitbucket Cloud OAuth consumer, registered on
 * bitbucket.org rather than developer.atlassian.com). Same shape as the
 * atlassian-confluence connector route.
 */
